...
export class initial1662896310718 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "users" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "password_hash" character varying NOT NULL, "salt" character varying NOT NULL, CONSTRAINT "UQ_51b8b26ac168fbe7d6f5653e6cf" UNIQUE ("name"), CONSTRAINT "PK_951b8f1dfc94ac1d0301a14b7e1" PRIMARY KEY ("uuid"))`
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "product_modifiers" ("product" uuid NOT NULL, "modifier" uuid NOT NULL, CONSTRAINT "PK_86308143cfaca5217fcd0fed175" PRIMARY KEY ("product", "modifier"))`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_d384aa1cdc7071220da46774c7" ON "product_modifiers" ("product") `
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_5ba6984f8873faacef278cb11a" ON "product_modifiers" ("modifier") `
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "discount_strategy_products" ("discount_strategy" uuid NOT NULL, "modifier" uuid NOT NULL, CONSTRAINT "PK_ec7797574f5cea9589caaef29c0" PRIMARY KEY ("discount_strategy", "modifier"))`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_39c07d95fc7fdb38a93c4b5136" ON "discount_strategy_products" ("discount_strategy") `
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_388dd5bfc6d44e3f1b9bfd37f4" ON "discount_strategy_products" ("modifier") `
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "discount_strategy_product_categories" ("discount_strategy" uuid NOT NULL, "modifier" uuid NOT NULL, CONSTRAINT "PK_939bec379b2ab1db2238ecac03b" PRIMARY KEY ("discount_strategy", "modifier"))`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_50ff9144ec336c4ae9a9d89fbc" ON "discount_strategy_product_categories" ("discount_strategy") `
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_77324b3cc3a9e5a527f42eab8c" ON "discount_strategy_product_categories" ("modifier") `
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "discount_strategy_modifiers" ("discount_strategy" uuid NOT NULL, "modifier" uuid NOT NULL, CONSTRAINT "PK_c30bffb3eb76e58818b0f0a1a24" PRIMARY KEY ("discount_strategy", "modifier"))`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_cef5c649dfccb48a857a18b5af" ON "discount_strategy_modifiers" ("discount_strategy") `
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_4697db9602f3e36cb86b9f2cc2" ON "discount_strategy_modifiers" ("modifier") `
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_4697db9602f3e36cb86b9f2cc2"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_cef5c649dfccb48a857a18b5af"`
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "discount_strategy_modifiers"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_77324b3cc3a9e5a527f42eab8c"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_50ff9144ec336c4ae9a9d89fbc"`
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "discount_strategy_product_categories"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_388dd5bfc6d44e3f1b9bfd37f4"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_39c07d95fc7fdb38a93c4b5136"`
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "discount_strategy_products"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_5ba6984f8873faacef278cb11a"`
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_d384aa1cdc7071220da46774c7"`
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "product_modifiers"`);
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS "discount_strategies"`);
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS "modifier_categories"`);
  }
}
